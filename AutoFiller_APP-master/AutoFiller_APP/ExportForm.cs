                        ...
                        using (SaveFileDialog sfd = new SaveFileDialog() { Filter = "Excel Workbook|*.xlsx" })
                        {
                            if (sfd.ShowDialog() == DialogResult.OK)
                            {
                                ...
                                dt.Columns.AddRange(new DataColumn[49] {
                                            ...
                                            new DataColumn("Preparer Fullname"),
                                            new DataColumn("Applicant First Name"),
                                            new DataColumn("Applicant Middle Name"),
                                            new DataColumn("Applicant Applicant Last Name"),
                                            ...
                                            new DataColumn("Applicant Application Statement 1aORb"),
                                            new DataColumn("Applicant Application Statetemnt 1bfield"),
                                            new DataColumn("Applicant Applicant Phone Number"),
                                            new DataColumn("Applicant Mailing Zip"),
                                            new DataColumn("Applicant Phone"),
                                            new DataColumn("Applicant Mobile Phone"),
                                            new DataColumn("Applicant Email"),
                                            new DataColumn("Applicant Language"),
                                            ...
                                            new DataColumn("Interpreter Name"),
